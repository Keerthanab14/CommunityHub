        ...
        >
            ...
            <div className="w-full px-4 py-3">
                ...
                {post?.postImageUrl ? (<div 
                    className="max-w-3xl max-h-80 mx-auto bg-green-100 rounded-md cursor-pointer"
                    onClick={() => navigate(`/post/${post.id}`)}>
                    <img
                ...
                <div className="flex justify-between pt-8">
                    ...
                    {isBookmarked ? (
                        <MdOutlineBookmark className="text-xl cursor-pointer mr-3 text-green-600" onClick={e => {
                            e.stopPropagation();
