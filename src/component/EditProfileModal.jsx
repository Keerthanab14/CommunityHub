            ...
            <div className="flex flex-col">
                <div className="flex flex-col mx-auto">
                    ...
                    <div className="relative">
                        ...
                        <label className="w-8 h-8 absolute right-9 bottom-1 bg-slate-200 p-1 rounded-full border-2 cursor-pointer border-white fill-green-600 stroke-0 hover:stroke-2 text-2xl">
                            <input
                                className="hidden"
                                type="file"
                ...
                <div className="flex justify-between m-1">
                    ...
                    <button 
                        className="px-3 w-18 h-8 bg-green-600 hover:bg-green-800 text-white rounded-xl shadow-md hover:shadow-lg transition duration-150 ease-in-out" 
