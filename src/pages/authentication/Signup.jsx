...
export const Signup = () => {
    ...
    return (
        <div className="flex flex-col mt-4">
            <header className="place-self-center text-xl font-bold flex py-4 text-green-600">
                CommunityHub
            </header>
            ...
            <div className="flex flex-col pb-1 shadow-none bg-slate-100 rounded-lg w-1/4 mx-auto min-w-max">
                ...
                <form className="mx-8 flex flex-col">
                    ...
                    <button className="my-3 text-x cursor-pointer text-center py-1 border2 bg-green-600 hover:bg-green-700 text-white font-semibold" onClick={(e) => formSignUpHandler(e)} >Sign Up</button>

                    <p className="my-2 text-center text-sm self-center text-green-700 font-medium">
