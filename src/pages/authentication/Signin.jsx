...
export const Signin = () => {
    ...
    return (
        ...
        <div className="flex flex-col justify-items-center items-center">
            ...
            <h1 className="mt-16 text-4xl font-bold text-green-600 hidden lg:block tracking-wider">CommunityHub</h1>
            ...
            <div className="mx-auto w-full ">
                <div className="md:container md:mx-auto mx-auto flex">
                    ...
                    <div className="mx-auto mt-14 sm:mx-28 sm:mt-16">
                        <header className="text-2xl font-bold text-center py-2 mb-2 text-green-600 sm:hidden">
                            <Link to="/home"> CommunityHub </Link>
                        </header>
                            ...
                            <form className="mx-8 flex flex-col">
                                ...
                                <label className="text-sm py-1 text-slate-900">Username<span className="form_label"></span>
                                    <input
                                        name="username"
                                        value={username}
                                        className="py-1 px-2 w-full mt-4 rounded-none border-2 focus:outline-green-400"
                                        type="text"
                                        required={true}
                                ...
                                <Link
                                    to="/home"
                                    className="my-3 text-x cursor-pointer text-center py-1 border-2 font-semibold  bg-green-600 hover:bg-green-700 text-white"
                                    onClick={(e) => formSignInHandler(e)} >
                                    Login
                                </Link>

                                <Link
                                    to="/home" className="my-3 text-x cursor-pointer text-center py-1 border-2 font-semibold  text-green-700 hover:bg-slate-200"
                                    onClick={(e) => formGuestSignInHandler(e)} >
                                    Guest Login
                                </Link>

                                <p className="my-2 text-center text-sm text-slate-800 self-center font-medium"> New to CommunityHub?
                                    <Link className="text-green-700" to="/signup"> Sign Up </Link>
                                </p>
