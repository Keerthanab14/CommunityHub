                    ...
                    <main className="w-full sm:basis-2/3">
                        ...
                        <div className="flex flex-col border ml-0 sm:mr-0 sm:mx-3 pl-2 pr-1 sm:pr-0 sm:px-5 py-3">
                            ...
                            <div className="px-3">
                                ...
                                {currentPost?.postImageUrl ? (<div className="max-w-3xl max-h-80 mx-auto bg-green-100 rounded-md">
                                    <img
                                ...
                                <div className="flex justify-between py-4 px-2 border-t">
                                    ...
                                    {isBookmarked ? (
                                        <MdOutlineBookmark className="text-xl cursor-pointer text-green-700" onClick={e => {
                                            e.stopPropagation();
                                ...
                                <div className="flex justify-between items-center p-3 px-2 border-y-2 w-full focus:outline-none gap-4">
                                    ...
                                    <button
                                        ...
                                        className="disabled:cursor-not-allowed p-2 rounded-[20rem] bg-green-600 hover:bg-green-800 text-white shadow-md 
