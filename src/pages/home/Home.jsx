...
export const Home = () => {
    ...
    const postHandler = async (e) => {
        ...
        if (postImageUrl) {
            ...
            formData.append("upload_preset", "CommunityHub-social");
            formData.append("folder", "CommunityHub");
            ...
            <div className="flex justify-center px-5 sm:px-32 md:mt-4">
                <div className="flex h-screen w-screen">
                    ...
                    <main className="md:mx-4 w-full sm:basis-2/3">
                        ...
                        <header className="text-xl font-bold flex py-4 text-green-600 sm:hidden">
                        ...
                        <>
                                ...
                                <div className="w-full px-4">
                                    ...
                                    <div className="flex justify-between">
                                        <label className="flex m-2">
                                            ...
                                            />
                                            <BsFillImageFill className="text-2xl mt-1 text-green-700 cursor-pointer" />
                                        </label>
                                        <button
                                            disabled={!content.trim().length && !postImageUrl}
                                            className="p-2.5 bg-green-600 hover:bg-green-800 text-white rounded-xl shadow-md hover:shadow-lg transition duration-150 ease-in-out disabled:cursor-not-allowed"
                                            onClick={postHandler}>
                                            Post
                                        </button>
                                    </div>
                            ...
                            <div className="flex pl-0.5 pr-0.5 sm:pr-6 sm:px-5 py-3 justify-between relative">
                                ...
                                <GiSettingsKnobs
                                    className="fill-green-600 stroke-0 hover:stroke-2 text-2xl cursor-pointer"
