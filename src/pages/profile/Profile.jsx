                ...
                <div className="flex h-screen w-screen">
                    ...
                    <main className="md:mx-4 w-full sm:basis-2/3">
                        ...
                        <header className="hidden sm:flex m-4 w-full justify-between">
                            ...
                            <FiLogOut className="mr-2 w-5 h-5 text-green-700 cursor-pointer" onClick={() => dispatch(signOutHandler())} />
                        </header>

                        <header className="text-xl font-bold flex py-4 text-green-600 sm:hidden justify-between">
                            <Link to="/home" id="hero-logo"> CommunityHub </Link>
                            <FiLogOut className="w-5 h-5 text-green-700 cursor-pointer" onClick={() => dispatch(signOutHandler())} />
                        </header>
                            ...
                            <div className="sm:ml-5 my-6 flex flex-col space-between">
                                ...
                                <div className="flex mx-auto gap-8">
                                    ...
                                    <div className="flex flex-col mt-2">
                                        ...
                                        <button
                                            className="mr-8 mt-4 px-3 w-18 h-8 bg-green-600 hover:bg-green-800 text-white rounded-xl shadow-md hover:shadow-lg transition duration-150 ease-in-out"
                                ...
                                <div className="mt-4 flex flex-col items-center">
                                    ...
                                    <h2 className="font-semibold text-green-600">{currentUser?.website}</h2>
                                </div>
                    ...
                    <AsideRight />
                    <a href="#">
                        <AiOutlineArrowUp className="hidden sm:block fixed bottom-0 right-20 bg-green-300 text-slate-50 text-5xl p-3 rounded-full mb-2 mr-20 hover:bg-green-500" />
                    </a>
                </div>
            </div>
        </div>
